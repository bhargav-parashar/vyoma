    ...
    <div className=" pt-25">
      ...
      <div className=" h-[80%] w-[40%]">
        ...
        <div className="border-b-1 border-gray-300 p-2">
          ...
          <p className="text-gray-400 sm:text-l 2xl:text-xl ">{selectedProduct.name}</p>
        ...
        <div className=" px-2">
          <p>
            ...
            <span className=" text-gray-400 sm:text-l 2xl:text-xl pl-2">MRP</span>{" "}
        ...
        <div className=" p-2">
            ...
            <div>
                <div className="flex items-center justify-start gap-2 mb-1">
                  ...
                  <span>{`Launced on ${format( new Date( selectedProduct.launchDate), "MMM dd YYY" )} `}</span>
                </div>
                <div className="flex items-center justify-start gap-2 mb-1">
                  <MapPinIcon className="h-5 w-5 " />
                  <span>{`Origin : ${ selectedProduct?.origin.charAt(0).toUpperCase()+selectedProduct?.origin.substring(1) }`}</span>
                </div>
            </div>
        </div>
